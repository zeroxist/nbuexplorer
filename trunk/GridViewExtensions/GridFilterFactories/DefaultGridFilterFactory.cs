...
namespace NbuExplorer.GridViewExtensions.GridFilterFactories
{
    /// <summary>
    ...
    public class DefaultGridFilterFactory : GridFilterFactoryBase
    {
        ...
        private bool _defaultShowNumericInBetweenOperator;
        ...
        public DefaultGridFilterFactory()
        {
            ...
            AddGridFilter(typeof (ushort), typeof (NumericGridFilter));
            AddGridFilter(typeof (ulong), typeof (NumericGridFilter));
        ...
        {
            if (!gridFilterType.IsClass &&
                !gridFilterType.IsValueType)
        ...
        protected override IGridFilter CreateGridFilterInternal(DataGridViewColumn column)
        {
            ...
            {
                bool containsDbNull;
                var values = DistinctValuesGridFilter.GetDistinctValues(column, _maximumDistinctValues, out containsDbNull);
                if (values != null)
            ...
            if (result == null)
            {
                ...
                {
                    var gridFilterType = _hash[dataType] as Type;
