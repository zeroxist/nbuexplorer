...
namespace NbuExplorer.GridViewExtensions
{
    ...
    public class DataGridFilterExtender : Component, ISupportInitialize
    {
        ...
        /// <summary>
        ///     Filter not related to extended UI.
        /// </summary>
        internal string CustomFilter
        {
            get { return _filters.CustomFilter; }
            set { _filters.CustomFilter = value; }
        }
        ...
        public DataGridView DataGridView
        {
            ...
            set
            {
                ...
                if (_grid != null)
                {
                    _grid.LocationChanged -= OnGridLocationChanged;
                    _grid.Resize -= OnGridResize;
                    _grid.ParentChanged -= OnGridParentChanged;
                }
        ...
        private void RemoveFilterControl()
        {
            ...
            {
                _filters.AfterFiltersChanged -= OnAfterFiltersChanged;
                _filters.BeforeFiltersChanging -= OnBeforeFiltersChanging;
                _filters.GridFilterBound -= OnGridFilterBound;
                _filters.GridFilterUnbound -= OnGridFilterUnbound;
                _currentParent.Controls.Remove(_filters);
                _currentParent.BackColorChanged -= OnColorsChanged;
                _currentParent.ForeColorChanged -= OnColorsChanged;
                _currentParent = null;
            }
        }
